...
- Если classifierResult.primaryIntent = unknown, но rawRequest содержит "проверь орфографию", "проверь пунктуацию", "проверь орфографию и пунктуацию", "отформатируй", "исправь по редполитике", "проверь по редполитике" или "проверь форматирование" — считай это check_rules и вызови check_rules_tool с текстом после двоеточия или текстом в кавычках.
