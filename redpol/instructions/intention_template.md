...
11. Explain guideline
    Если пользователь спрашивает “как писать”, “как выравнивать”, “как располагать”, “как оформлять”, “какое правило”, “какой паттерн”, “какие требования”, “расскажи про паттерн”, “что говорит редполитика про”:
    primaryIntent = explain_guideline.
    action = explain.
    needsPattern = true.
    needsRag = false.
...
3. Не выбирай unknown, если originalText содержит явную инструкцию "проверь", "исправь", "перепиши", "найди", "расскажи", "как писать", "как выравнивать", "как располагать", "как оформлять", "напиши", "сгенерируй", "придумай".
