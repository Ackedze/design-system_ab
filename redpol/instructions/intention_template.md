...
8. Generate UI text
   ...
   Явно выбирай generate_ui_text для запросов про текст кнопки, если пользователь не просит проверить уже готовый вариант:
   ...
   component = "button".
   needsPattern = true.
   needsRag = false, если пользователь не просит реальные примеры или "как у нас".
...
3. Не выбирай unknown, если originalText содержит явную инструкцию "проверь", "исправь", "перепиши", "найди", "расскажи", "как писать", "напиши", "сгенерируй", "придумай".
