# Helpbook — MVP component contract

Папка содержит сгенерированный слой component-contract для **Web :: Corp Presets / Helpbook**.

Raw Figma catalog остаётся source of truth:

`../../../../web/components/web-corp-presets/Web _ Corp Presets -- Helpbook.json`
...
- Сгенерировано: `2026-04-28T19:56:09.306Z`
- Компонентов: `13`
