# Header — MVP component contract

Папка содержит сгенерированный слой component-contract для **Web :: Corp Presets / Header**.

Raw Figma catalog остаётся source of truth:

`../../../../web/components/web-corp-presets/Web _ Corp Presets -- Header.json`
...
- Сгенерировано: `2026-04-28T19:55:44.018Z`
- Компонентов: `2`
