# BodyHeader — MVP component contract

Папка содержит сгенерированный слой component-contract для **Web :: Corp Presets / BodyHeader**.

Raw Figma catalog остаётся source of truth:

`../../../../web/components/web-corp-presets/Web _ Corp Presets -- BodyHeader.json`
...
- Сгенерировано: `2026-04-28T19:55:50.725Z`
- Компонентов: `3`
