# Forms — MVP component contract

Папка содержит сгенерированный слой component-contract для **Web :: Corp Presets / Forms**.

Raw Figma catalog остаётся source of truth:

`../../../../web/components/web-corp-presets/Web _ Corp Presets -- Forms.json`
...
- Сгенерировано: `2026-04-28T19:55:21.296Z`
- Компонентов: `18`
