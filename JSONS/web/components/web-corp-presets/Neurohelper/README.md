# Neurohelper — MVP component contract

Папка содержит сгенерированный слой component-contract для **Web :: Corp Presets / Neurohelper**.

Raw Figma catalog остаётся source of truth:

`../../../../web/components/web-corp-presets/Web _ Corp Presets -- Neurohelper.json`
...
- Библиотека: `Web :: Corp Presets`
- Сгенерировано: `2026-04-28T19:56:32.204Z`
- Компонентов: `25`
