# PureCell — MVP component contract

Папка содержит сгенерированный слой component-contract для **Web :: Core Wrappers / PureCell**.

Raw Figma catalog остаётся source of truth:

`../../../../web/components/web-core/wrappers/Web _ Core Wrappers -- PureCell.json`
...
- Сгенерировано: `2026-04-28T18:16:59.443Z`
- Компонентов: `24`
