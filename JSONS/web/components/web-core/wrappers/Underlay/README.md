# Underlay — MVP component contract

Папка содержит сгенерированный слой component-contract для **Web :: Core Wrappers / Underlay**.

Raw Figma catalog остаётся source of truth:

`../../../../web/components/web-core/wrappers/Web _ Core Wrappers -- Underlay.json`
...
- Сгенерировано: `2026-04-28T18:17:09.908Z`
- Компонентов: `1`
