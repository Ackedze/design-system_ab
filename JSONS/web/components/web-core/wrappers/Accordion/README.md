# Accordion — MVP component contract

Папка содержит сгенерированный слой component-contract для **Web :: Core Wrappers / Accordion**.

Raw Figma catalog остаётся source of truth:

`../../../../web/components/web-core/wrappers/Web _ Core Wrappers -- Accordion.json`
...
- Библиотека: `Web :: Core Wrappers`
- Сгенерировано: `2026-04-28T18:16:48.278Z`
- Компонентов: `6`
