# HatchingProgressBar — MVP component contract

Папка содержит сгенерированный слой component-contract для **Web :: Core ProgressBars / HatchingProgressBar**.

Raw Figma catalog остаётся source of truth:

`../../../../web/components/web-core/progressbars/Web _ Core ProgressBars -- HatchingProgressBar.json`
...
- Библиотека: `Web :: Core ProgressBars`
- Сгенерировано: `2026-04-28T18:15:20.422Z`
- Компонентов: `1`
