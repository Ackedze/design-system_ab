# CircularProgressBar — MVP component contract

Папка содержит сгенерированный слой component-contract для **Web :: Core ProgressBars / CircularProgressBar**.

Raw Figma catalog остаётся source of truth:

`../../../../web/components/web-core/progressbars/Web _ Core ProgressBars -- CircularProgressBar.json`
...
- Сгенерировано: `2026-04-28T18:15:28.017Z`
- Компонентов: `23`
