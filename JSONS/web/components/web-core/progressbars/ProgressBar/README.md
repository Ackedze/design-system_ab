# ProgressBar — MVP component contract

Папка содержит сгенерированный слой component-contract для **Web :: Core ProgressBars / ProgressBar**.

Raw Figma catalog остаётся source of truth:

`../../../../web/components/web-core/progressbars/Web _ Core ProgressBars -- ProgressBar.json`
...
- Сгенерировано: `2026-04-28T18:15:05.041Z`
- Компонентов: `2`
