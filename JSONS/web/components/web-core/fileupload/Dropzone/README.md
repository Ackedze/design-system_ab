# Dropzone — MVP component contract

Папка содержит сгенерированный слой component-contract для **Web :: Core File Upload / Dropzone**.

Raw Figma catalog остаётся source of truth:

`../../../../web/components/web-core/fileupload/Web _ Core File Upload -- Dropzone.json`
...
- Сгенерировано: `2026-04-28T18:03:35.814Z`
- Компонентов: `2`
