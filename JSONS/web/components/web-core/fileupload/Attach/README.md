# Attach — MVP component contract

Папка содержит сгенерированный слой component-contract для **Web :: Core File Upload / Attach**.

Raw Figma catalog остаётся source of truth:

`../../../../web/components/web-core/fileupload/Web _ Core File Upload -- Attach.json`
...
- Сгенерировано: `2026-04-28T18:03:27.333Z`
- Компонентов: `5`
