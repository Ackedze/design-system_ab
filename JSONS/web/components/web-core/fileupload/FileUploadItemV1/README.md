# FileUploadItemV1 — MVP component contract

Папка содержит сгенерированный слой component-contract для **Web :: Core File Upload / FileUploadItemV1**.

Raw Figma catalog остаётся source of truth:

`../../../../web/components/web-core/fileupload/Web _ Core File Upload -- FileUploadItemV1.json`
...
- Библиотека: `Web :: Core File Upload`
- Сгенерировано: `2026-04-28T18:03:54.547Z`
- Компонентов: `4`
