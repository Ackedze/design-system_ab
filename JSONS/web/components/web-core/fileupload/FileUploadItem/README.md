# FileUploadItem — MVP component contract

Папка содержит сгенерированный слой component-contract для **Web :: Core File Upload / FileUploadItem**.

Raw Figma catalog остаётся source of truth:

`../../../../web/components/web-core/fileupload/Web _ Core File Upload -- FileUploadItem.json`
...
- Сгенерировано: `2026-04-28T18:03:44.521Z`
- Компонентов: `5`
