# SortableList — MVP component contract

Папка содержит сгенерированный слой component-contract для **Web _ Core Misc / SortableList**.

Raw Figma catalog остаётся source of truth:

`../../../../web/components/web-core/misc/Web _ Core Misc -- SortableList.json`
...
- Библиотека: `Web _ Core Misc`
- Сгенерировано: `2026-06-17T08:57:18.024Z`
- Компонентов: `4`
