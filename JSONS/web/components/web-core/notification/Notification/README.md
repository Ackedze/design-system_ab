# Notification — MVP component contract

Папка содержит сгенерированный слой component-contract для **Web :: Core Notification / Notification**.

Raw Figma catalog остаётся source of truth:

`../../../../web/components/web-core/notification/Web _ Core Notification -- Notification.json`
...
- Библиотека: `Web :: Core Notification`
- Сгенерировано: `2026-04-28T18:10:33.790Z`
- Компонентов: `1`
