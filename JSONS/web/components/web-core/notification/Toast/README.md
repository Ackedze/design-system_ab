# Toast — MVP component contract

Папка содержит сгенерированный слой component-contract для **Web :: Core Notification / Toast**.

Raw Figma catalog остаётся source of truth:

`../../../../web/components/web-core/notification/Web _ Core Notification -- Toast.json`
...
- Сгенерировано: `2026-04-28T18:10:43.576Z`
- Компонентов: `4`
