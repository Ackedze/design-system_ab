# Confirmation — MVP component contract

Папка содержит сгенерированный слой component-contract для **Web :: Core Authentication / Confirmation**.

Raw Figma catalog остаётся source of truth:

`../../../../web/components/web-core/authentication/Web _ Core Authentication -- Confirmation.json`
...
- Библиотека: `Web :: Core Authentication`
- Сгенерировано: `2026-04-28T18:01:43.762Z`
- Компонентов: `21`
