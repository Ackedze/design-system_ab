# PassCode — MVP component contract

Папка содержит сгенерированный слой component-contract для **Web :: Core Authentication / PassCode**.

Raw Figma catalog остаётся source of truth:

`../../../../web/components/web-core/authentication/Web _ Core Authentication -- PassCode.json`
...
- Сгенерировано: `2026-04-28T18:01:55.255Z`
- Компонентов: `12`
