# PatternLock — MVP component contract

Папка содержит сгенерированный слой component-contract для **Web :: Core Authentication / PatternLock**.

Raw Figma catalog остаётся source of truth:

`../../../../web/components/web-core/authentication/Web _ Core Authentication -- PatternLock.json`
...
- Сгенерировано: `2026-04-28T18:02:03.967Z`
- Компонентов: `12`
