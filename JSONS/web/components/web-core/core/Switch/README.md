# Switch component contract MVP

This folder contains an experimental component-contract layer for **Web _ Core / Switch**.
...
- `audit-mapping.json` — how Apollo should classify and group Switch diffs.
...
Apollo should use the generated contract to understand Switch states and baselines, then apply overrides/rules to interpret whether a diff is a component property change, slot configuration, layer customization or content text review.
...
This is a draft for Switch. It covers:
