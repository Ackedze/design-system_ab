# NavigationBar — MVP component contract

Папка содержит сгенерированный слой component-contract для **Web :: Core Navigation / NavigationBar**.

Raw Figma catalog остаётся source of truth:

`../../../../web/components/web-core/navigation/Web _ Core Navigation -- NavigationBar.json`
...
- Библиотека: `Web :: Core Navigation`
- Сгенерировано: `2026-04-28T18:08:39.295Z`
- Компонентов: `6`
