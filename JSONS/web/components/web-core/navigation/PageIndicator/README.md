# PageIndicator — MVP component contract

Папка содержит сгенерированный слой component-contract для **Web :: Core Navigation / PageIndicator**.

Raw Figma catalog остаётся source of truth:

`../../../../web/components/web-core/navigation/Web _ Core Navigation -- PageIndicator.json`
...
- Сгенерировано: `2026-04-28T18:08:55.407Z`
- Компонентов: `28`
