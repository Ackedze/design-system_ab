# Pagination — MVP component contract

Папка содержит сгенерированный слой component-contract для **Web :: Core Navigation / Pagination**.

Raw Figma catalog остаётся source of truth:

`../../../../web/components/web-core/navigation/Web _ Core Navigation -- Pagination.json`
...
- Сгенерировано: `2026-04-28T18:08:47.704Z`
- Компонентов: `5`
