# Cursor — MVP component contract

Папка содержит сгенерированный слой component-contract для **Web :: Core Helpers / Cursor**.

Raw Figma catalog остаётся source of truth:

`../../../../web/components/web-core-helpers/Web _ Core Helpers -- Cursor.json`
...
- Сгенерировано: `2026-04-29T11:42:04.667Z`
- Компонентов: `1`
