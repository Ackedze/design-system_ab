# Comments — MVP component contract

Папка содержит сгенерированный слой component-contract для **Web :: Core Helpers / Comments**.

Raw Figma catalog остаётся source of truth:

`../../../../web/components/web-core-helpers/Web _ Core Helpers -- Comments.json`
...
- Сгенерировано: `2026-04-29T11:40:34.712Z`
- Компонентов: `1`
