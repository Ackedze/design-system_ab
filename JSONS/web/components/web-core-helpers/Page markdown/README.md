# Page markdown — MVP component contract

Папка содержит сгенерированный слой component-contract для **Web :: Core Helpers / Page markdown**.

Raw Figma catalog остаётся source of truth:

`../../../../web/components/web-core-helpers/Web _ Core Helpers -- Page markdown.json`
...
- Сгенерировано: `2026-04-29T11:42:24.163Z`
- Компонентов: `10`
