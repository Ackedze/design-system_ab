# Documentation — MVP component contract

Папка содержит сгенерированный слой component-contract для **Web :: Core Helpers / Documentation**.

Raw Figma catalog остаётся source of truth:

`../../../../web/components/web-core-helpers/Web _ Core Helpers -- Documentation.json`
...
- Библиотека: `Web :: Core Helpers`
- Сгенерировано: `2026-04-29T11:42:14.296Z`
- Компонентов: `16`
