# BentoGrid — MVP component contract

Папка содержит сгенерированный слой component-contract для **Web _ Сorp Promo Components / BentoGrid**.

Raw Figma catalog остаётся source of truth:

`../../../../web/components/web-corp-promo/Web _ Сorp Promo Components -- BentoGrid.json`
