...
**In progress**. Продуктовая семантика подтверждена владельцем 2026-08-03. Manual-документы подготовлены к ручному ревью; статус `Ready` будет установлен только после проверки комплекта и runtime-кейсов.
