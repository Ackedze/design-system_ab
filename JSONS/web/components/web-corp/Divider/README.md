# Divider component contract MVP

This folder contains a generated component-contract layer for **Web _ Corp Components / Divider**.

The raw Figma catalog remains the source of truth:

`../Web _ Corp Components -- Divider.json`
