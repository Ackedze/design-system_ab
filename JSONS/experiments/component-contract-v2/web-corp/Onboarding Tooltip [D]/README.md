# Onboarding Tooltip [D] component contract v2 experiment
...
- Source package: `JSONS/web/components/web-corp/Onboarding Tooltip [D]`
- Component API facts: 6
- Executable RuleIR entries: 7
- Deterministic coverage: 6/16
