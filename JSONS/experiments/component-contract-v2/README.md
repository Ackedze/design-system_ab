...
| web-corp.corporate-system-message | 4/24 | 20 |
...
`capability-matrix.json`. Across the sample, 206
of 498 deterministic rules compile (0.4137);
292 remain unsupported. A source rule is executable only when its assertion
