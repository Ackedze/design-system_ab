...
`capability-matrix.json`. Across the sample, 204
of 498 deterministic rules compile (0.4096);
294 remain unsupported. A source rule is executable only when its assertion
