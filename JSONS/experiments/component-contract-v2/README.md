...
| web-corp.corporate-system-message | 3/24 | 21 |
...
`capability-matrix.json`. Across the sample, 205
of 498 deterministic rules compile (0.4116);
293 remain unsupported. A source rule is executable only when its assertion
