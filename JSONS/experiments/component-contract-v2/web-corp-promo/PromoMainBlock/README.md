# PromoMainBlock component contract v2 experiment
...
- Source package: `JSONS/web/components/web-corp-promo/PromoMainBlock`
- Component API facts: 10
- Executable RuleIR entries: 3
- Deterministic coverage: 2/20
