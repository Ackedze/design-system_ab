...
### Rule 34: Называй страницу осмысленным главным заголовком

- ruleId: rule:components.title-view.main-title-names-page
- severity: error
- appliesTo: text.content
- checkType: llm
- autofix: no

`Title` в `TitleView` с `View=xLarge` должен кратко и осмысленно называть страницу, её основной объект или пользовательскую задачу. Не используй технические заглушки, тестовые, шуточные и бессодержательные формулировки.

Подтверждай ошибку, когда назначение главного заголовка и его несоответствие однозначны по тексту и контексту страницы. Если назначение экрана нельзя установить, сначала запроси пояснение; без достаточного контекста передай случай на проверку человеку.

#### Правильно

```text
TitleView View=xLarge
Title: Заявка на кредитование
...
Главный заголовок задаёт назначение страницы и помогает пользователю сразу понять, с каким объектом или задачей он работает. Заглушки и бессодержательные формулировки разрушают эту ориентацию.
...
- Проверять, что `Title` главного `TitleView View=xLarge` осмысленно называет страницу, её основной объект или пользовательскую задачу; технические заглушки, тестовые, шуточные и бессодержательные формулировки считать ошибкой только при однозначном контексте.
...
- Смысловая уместность конкретного заголовка, если назначение страницы нельзя однозначно установить по переданному контексту.
